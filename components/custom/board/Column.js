...
export default function Column({column, onCardDrop}) {
    ...
    return (
        <>
            <div
                className="kanban-board-column flex-none rounded-xl transition-all duration-100 shadow-none bg-slate-200 dark:bg-slate-700">
                <header
                    className="column-drag-handle relative flex justify-between items-center rounded-xl px-4 py-2 cursor-grab">
                    ...
                    <div className="flex items-center">
                        <Dropdown
                            ...
                            label={<Icon className="w-7 h-7 hover:bg-slate-300 rounded dark:hover:bg-slate-800"
                                         icon="ph:dots-three-bold"/>}
                        >
                            <div className="py-2 text-sm cursor-pointer">
                                <h2 className="text-[14px] py-2 text-slate-700 dark:text-white text-center">Column
                                    actions</h2>
                                <div
                ...
                >
                    <Icon className="mr-1" icon="heroicons:plus"/> <span className="select-none">Add a card</span>
                </footer>
            </div>
            {/*column end*/}
            ...
            >
                <div className="text-base text-slate-600 dark:text-slate-300">
                    <form onSubmit={newCardFormik.handleSubmit} className="space-y-4 ">
                        <Textinput
                            name="title"
                            label="Card title"
                            type="text"
